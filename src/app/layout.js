...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://boltzmann.s3.us-east-1.amazonaws.com/Abstract/AI-Earbud-6.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      'https://boltzmann.s3.us-east-1.amazonaws.com/Abstract/AI-Earbud-6.jpg',
    ],
  },
  icons: {
    icon: [
